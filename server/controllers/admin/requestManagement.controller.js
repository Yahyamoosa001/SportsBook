...
export const approveOwnerRequest = async (req, res) => {
  ...
  try {
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <p>Congratulations! You can now complete your account registration by setting up your password:</p>
        <button style="background-color: #4CAF50; border: none; padding: 10px 20px; text-align: center; display: inline-block; margin: 10px 0; cursor: pointer; border-radius: 5px;">
            <a href="${process.env.OWNER_URL}/complete-registration" style="color: white; text-decoration: none; font-size: 16px;">Complete Registration</a>
        </button>
        <p style="margin-top: 20px;">Please use the email address: <strong>${ownerRequest.email}</strong> when completing your registration.</p>
    </div>
`;
