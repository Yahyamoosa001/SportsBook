      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            ...
            <li>
              <Link to="/auth/facilities">Facilities</Link>
            </li>
            <li>
        ...
        <Link to="/auth" className="btn btn-ghost normal-case text-xl">
          <div className="w-10 h-10 bg-primary text-primary-content rounded-lg flex items-center justify-center font-bold text-lg">
            SB
          </div>
          Sportbook
        </Link>
